/*
 PlayCanvas Engine v0.169.12 revision 179f47b
 http://playcanvas.com
...
*/
var pc={version:"0.169.12",revision:"179f47b",config:{},common:{},apps:{},data:{},unpack:function(){console.warn("pc.unpack has been deprecated and will be removed shortly. Please update your code.")},makeArray:function(f){var a,b=[],d=f.length;for(a=0;a<d;++a)b.push(f[a]);return b},type:function(f){if(null===f)return"null";var a=typeof f;return"undefined"==a||"number"==a||"string"==a||"boolean"==a?a:_typeLookup[Object.prototype.toString.call(f)]},extend:function(f,a){var b,d;
...
case pc.CULLFACE_FRONTANDBACK:b.enable(b.CULL_FACE),b.cullFace(b.FRONT_AND_BACK)}this.cullMode=a}},setIndexBuffer:function(a){if(this.indexBuffer!==a){this.indexBuffer=a;var b=this.gl;b.bindBuffer(b.ELEMENT_ARRAY_BUFFER,a?a.bufferId:null)}},setVertexBuffer:function(a,b){if(this.vertexBuffers[b]!==a){this.vertexBuffers[b]=a;for(var d=0,e=a.getFormat().elements,g=e.length;d<g;){var f=e[d++];f.stream=b;f.scopeId.setValue(f)}this.attributesInvalidated=!0}},setShader:function(a){a!==this.shader&&(this.shader=
a,this.gl.useProgram(a.program),this.attributesInvalidated=!0)},getBoneLimit:function(){return this.boneLimit},setBoneLimit:function(a){this.boneLimit=a},enableValidation:function(){console.warn("enableValidation: This function is deprecated and will be removed shortly.")},validate:function(){console.warn("validate: This function is deprecated and will be removed shortly.")},resizeCanvas:function(a,b){this._width=a;this._height=b;var d=Math.min(this._maxPixelRatio,window.devicePixelRatio),a=a*d,b=
b*d;this.canvas.width=a;this.canvas.height=b;this.fire("resizecanvas",a,b)}};Object.defineProperty(g.prototype,"width",{get:function(){return this.gl.drawingBufferWidth||this.canvas.width}});Object.defineProperty(g.prototype,"height",{get:function(){return this.gl.drawingBufferHeight||this.canvas.height}});Object.defineProperty(g.prototype,"fullscreen",{get:function(){return!!document.fullscreenElement},set:function(a){a?this.gl.canvas.requestFullscreen():document.exitFullscreen()}});Object.defineProperty(g.prototype,
...
a.shadingModel===pc.SPECULAR_PHONG?(a.fresnelModel=0,a.specularAA=!1,a.prefilteredCubemap=!1):a.fresnelModel=0===a.fresnelModel?pc.FRESNEL_SCHLICK:a.fresnelModel;var e=a.cubeMap||a.prefilteredCubemap&&a.useSpecular,g=a.sphereMap||e||a.dpAtlas,h=pc.precalculatedTangents,k=a.useTexCubeLod;if(a.cubeMap||a.prefilteredCubemap)a.sphereMap=null;a.dpAtlas&&(a.sphereMap=a.cubeMap=a.prefilteredCubemap=e=null);a.useSpecular||(a.specularMap=a.glossMap=null);var n=d||g||a.ambientSH;this.options=a;var r=pc.programlib.getSnippet,
l="",m="",s="",u=pc.shaderChunks;if(a.chunks){var w=[],B;for(B in u)u.hasOwnProperty(B)&&(a.chunks[B]?(w[B]=a.chunks[B],n||(w[B]=w[B].replace(/vertex_normal/g,"vec3(0)").replace(/vertex_tangent/g,"vec4(0)"))):w[B]=u[B]);u=w}var l=l+u.baseVS,y=-1;if(!a.noShadow){for(b=0;b<a.lights.length;b++){var v=a.lights[b].getType();if(a.lights[b].getCastShadows()&&v!==pc.LIGHTTYPE_POINT){l+="uniform mat4 light"+b+"_shadowMatrixVS;\n";l+="uniform vec3 light"+b+"_shadowParamsVS;\n";l+="uniform vec3 light"+b+(v===
pc.LIGHTTYPE_DIRECTIONAL?"_directionVS":"_positionVS")+";\n";y=b;break}}0<=y&&(l+=u.shadowCoordVS)}w={vertex_position:pc.SEMANTIC_POSITION};m+="   vPositionW    = getWorldPosition(data);\n";a.useInstancing&&(w.instance_line1=pc.SEMANTIC_TEXCOORD2,w.instance_line2=pc.SEMANTIC_TEXCOORD3,w.instance_line3=pc.SEMANTIC_TEXCOORD4,w.instance_line4=pc.SEMANTIC_TEXCOORD5,l+=u.instancingVS);if(n){w.vertex_normal=pc.SEMANTIC_NORMAL;m+="   vNormalW    = data.normalW = getNormal(data);\n";a.sphereMap&&16>=f.fragmentUniformsCount&&
(l+=u.viewNormalVS,m+="   vNormalV    = getViewNormal(data);\n");if((a.heightMap||a.normalMap)&&h)w.vertex_tangent=pc.SEMANTIC_TANGENT,l+=u.tangentBinormalVS,m+="   vTangentW   = getTangent(data);\n   vBinormalW  = getBinormal(data);\n";0<=y&&(m=v==pc.LIGHTTYPE_DIRECTIONAL?m+("   data.lightDirNormW = light"+y+"_directionVS;\n"):m+("   getLightDirPoint(data, light"+y+"_positionVS);\n"),m+=this._nonPointShadowMapProjection(a.lights[y],"(data, light"+y+"_shadowMatrixVS, light"+y+"_shadowParamsVS);\n"))}var v=
[],x=[];for(B in pc._matTex2D)if(b=B+"Map",a[b+"VertexColor"]){var D=b+"Channel";a[D]=this._correctChannel(B,a[D])}else if(a[b]){var A=b+"Transform",C=b+"Uv",D=b+"Channel";a[C]=Math.min(a[C],1);a[D]=this._correctChannel(B,a[D]);C=a[C];v[C]=!0;x[C]=x[C]||a[b]&&!a[A]}for(b=0;2>b;b++)v[b]&&(w["vertex_texCoord"+b]=pc["SEMANTIC_TEXCOORD"+b],l+=u["uv"+b+"VS"],m+="   vec2 uv"+b+" = getUv"+b+"(data);\n"),x[b]&&(m+="   vUv"+b+" = uv"+b+";\n");m=[l,s,m,[]];for(B in pc._matTex2D)b=B+"Map",a[b]&&(A=b+"Transform",
a[A]&&(C=b+"Uv",this._setMapTransform(m,B,a[A],a[C])));l=m[0];s=m[1];m=m[2];a.vertexColors&&(w.vertex_color=pc.SEMANTIC_COLOR,m+="   vVertexColor = vertex_color;\n");a.skin?(w.vertex_boneWeights=pc.SEMANTIC_BLENDWEIGHT,w.vertex_boneIndices=pc.SEMANTIC_BLENDINDICES,l+=r(f,"vs_skin_decl"),l+=u.transformSkinnedVS,n&&(l+=u.normalSkinnedVS)):a.useInstancing?(l+=u.transformInstancedVS,n&&(l+=u.normalInstancedVS)):(l+=u.transformVS,n&&(l+=u.normalVS));l=l+"\n"+u.startVS;l+=m;B=l+="}";b=s;s=""+this._addVaryingIfNeeded(l,
"vec4","vMainShadowUv");s+=this._addVaryingIfNeeded(l,"vec4","vVertexColor");s+=this._addVaryingIfNeeded(l,"vec3","vPositionW");s+=this._addVaryingIfNeeded(l,"vec3","vNormalV");s+=this._addVaryingIfNeeded(l,"vec3","vNormalW");s+=this._addVaryingIfNeeded(l,"vec3","vTangentW");s+=this._addVaryingIfNeeded(l,"vec3","vBinormalW");s+=this._addVaryingIfNeeded(l,"vec2","vUv0");s+=this._addVaryingIfNeeded(l,"vec2","vUv1");s+=b;B=s+B;a.forceFragmentPrecision&&("highp"!=a.forceFragmentPrecision&&"mediump"!=
a.forceFragmentPrecision&&"lowp"!=a.forceFragmentPrecision)&&(a.forceFragmentPrecision=null);a.forceFragmentPrecision&&("highp"===a.forceFragmentPrecision&&"highp"!==f.maxPrecision&&(a.forceFragmentPrecision="mediump"),"mediump"===a.forceFragmentPrecision&&"lowp"===f.maxPrecision&&(a.forceFragmentPrecision="lowp"));l=a.forceFragmentPrecision?"precision "+a.forceFragmentPrecision+" float;\n\n":r(f,"fs_precision");if(a.customFragmentShader)return e=l+a.customFragmentShader,{attributes:w,vshader:B,fshader:e};
l+=s;l+=u.basePS;for(b=s=0;b<a.lights.length;b++)v=a.lights[b].getType(),l+="uniform vec3 light"+b+"_color;\n",v==pc.LIGHTTYPE_DIRECTIONAL?l+="uniform vec3 light"+b+"_direction;\n":(l+="uniform vec3 light"+b+"_position;\n",l+="uniform float light"+b+"_radius;\n",v==pc.LIGHTTYPE_SPOT&&(l+="uniform vec3 light"+b+"_spotDirection;\n",l+="uniform float light"+b+"_innerConeAngle;\n",l+="uniform float light"+b+"_outerConeAngle;\n")),a.lights[b].getCastShadows()&&!a.noShadow&&(l+="uniform mat4 light"+b+"_shadowMatrix;\n",
l=v==pc.LIGHTTYPE_POINT?l+("uniform vec4 light"+b+"_shadowParams;\n"):l+("uniform vec3 light"+b+"_shadowParams;\n"),l=v==pc.LIGHTTYPE_POINT?l+("uniform samplerCube light"+b+"_shadowMap;\n"):l+("uniform sampler2D light"+b+"_shadowMap;\n"),s++);l+="\n";b=a.heightMap?" + data.uvOffset":"";m=a.fastTbn?u.TBNfastPS:u.TBNPS;n&&(a.normalMap&&h?(l+=a.packedNormal?u.normalXYPS:u.normalXYZPS,h=this._uvSource(a.normalMapTransform,a.normalMapUv)+b,l=a.needsNormalFloat?l+(a.fastTbn?u.normalMapFloatTBNfastPS:u.normalMapFloatPS).replace(/\$UV/g,
h):l+u.normalMapPS.replace(/\$UV/g,h),l+=m):l+=u.normalVertexPS);l+=pc.programlib.gammaCode(a.gamma);l+=pc.programlib.tonemapCode(a.toneMap);l="linear"===a.fog?l+u.fogLinearPS:"exp"===a.fog?l+u.fogExpPS:"exp2"===a.fog?l+u.fogExp2PS:l+u.fogNonePS;a.useRgbm&&(l+=u.rgbmPS);if(e||a.prefilteredCubemap)l+=a.fixSeams?u.fixCubemapSeamsStretchPS:u.fixCubemapSeamsNonePS;n&&(l+=0<a.cubeMapProjection?u.cubeMapProjectBoxPS:u.cubeMapProjectNonePS,l+=a.skyboxIntensity?u.envMultiplyPS:u.envConstPS);l+=this._addMap("diffuse",
a,u,b);if(a.blendType!==pc.BLEND_NONE||a.alphaTest)l+=this._addMap("opacity",a,u,b);l+=this._addMap("emissive",a,u,b,null,a.emissiveFormat);a.useSpecular&&(l=a.specularAA&&a.normalMap?a.needsNormalFloat&&n?l+u.specularAaToksvigFloatPS:l+u.specularAaToksvigPS:l+u.specularAaNonePS,l+=this._addMap(a.useMetalness?"metalness":"specular",a,u,b),l+=this._addMap("gloss",a,u,b),0<a.fresnelModel&&(a.fresnelModel===pc.FRESNEL_SIMPLE?l+=u.fresnelSimplePS:a.fresnelModel===pc.FRESNEL_SCHLICK?l+=u.fresnelSchlickPS:
a.fresnelModel===pc.FRESNEL_COMPLEX&&(l+=u.fresnelComplexPS)));a.heightMap&&(a.normalMap||(l+=m),l+=this._addMap("height",a,u,"",u.parallaxPS));if(h=a.aoMap||a.aoMapVertexColor)l+=this._addMap("ao",a,u,b,a.aoMapVertexColor?u.aoVertPS:u.aoTexPS),a.occludeSpecular&&(l+=a.occludeSpecularFloat?u.aoSpecOccPS:u.aoSpecOccConstPS);m=a.rgbmReflection?"decodeRGBM":a.hdrReflection?"":"gammaCorrectInput";if(e||a.prefilteredCubemap)l=a.prefilteredCubemap?k?l+u.reflectionPrefilteredCubeLodPS.replace(/\$DECODE/g,
m):l+u.reflectionPrefilteredCubePS.replace(/\$DECODE/g,m):l+u.reflectionCubePS.replace(/\$textureCubeSAMPLE/g,a.rgbmReflection?"textureCubeRGBM":a.hdrReflection?"textureCube":"textureCubeSRGB");a.sphereMap&&(v=16<f.fragmentUniformsCount?u.reflectionSpherePS:u.reflectionSphereLowPS,v=v.replace(/\$texture2DSAMPLE/g,a.rgbmReflection?"texture2DRGBM":a.hdrReflection?"texture2D":"texture2DSRGB"),l+=v);a.dpAtlas&&(l+=u.reflectionDpAtlasPS.replace(/\$texture2DSAMPLE/g,a.rgbmReflection?"texture2DRGBM":a.hdrReflection?
"texture2D":"texture2DSRGB"));if((e||a.sphereMap||a.dpAtlas)&&a.refraction)l+=u.refractionPS;l=a.lightMap||a.lightMapVertexColor?l+this._addMap("light",a,u,b,a.lightMapVertexColor?u.lightmapSingleVertPS:u.lightmapSinglePS,a.lightMapFormat):a.ambientSH?l+u.ambientSHPS:a.prefilteredCubemap?k?l+u.ambientPrefilteredCubeLodPS.replace(/\$DECODE/g,m):l+u.ambientPrefilteredCubePS.replace(/\$DECODE/g,m):l+u.ambientConstantPS;0<s&&(l+=u.shadowCoordPS+u.shadowPS,0<=y&&(l+=u.shadowVSPS));l+=u.lightDiffuseLambertPS;
k=!1;a.useSpecular?(l+=a.shadingModel===pc.SPECULAR_PHONG?u.lightSpecularPhongPS:u.lightSpecularBlinnPS,a.sphereMap||e||a.dpAtlas||0<a.fresnelModel?l=0<a.fresnelModel?a.conserveEnergy?l+u.combineDiffuseSpecularPS:l+u.combineDiffuseSpecularNoConservePS:l+u.combineDiffuseSpecularOldPS:a.diffuseMap?l+=u.combineDiffuseSpecularNoReflPS:(l+=u.combineDiffuseSpecularNoReflSeparateAmbientPS,k=!0)):l+=u.combineDiffusePS;a.modulateAmbient&&!k&&(l+="uniform vec3 material_ambient;\n");a.alphaTest&&(l+="   uniform float alpha_ref;\n");
...
(l+="   getFresnel(data);\n");l+="   addAmbient(data);\n";a.modulateAmbient&&!k&&(l+="   data.diffuseLight *= material_ambient;\n");h&&!a.occludeDirect&&(l+="    applyAO(data);\n");if(d||g){if(e||a.sphereMap||a.dpAtlas)l+="   addReflection(data);\n";for(b=0;b<a.lights.length;b++)d=a.lights[b],v=d.getType(),v==pc.LIGHTTYPE_DIRECTIONAL?(l+="   data.lightDirNormW = light"+b+"_direction;\n",l+="   data.atten = 1.0;\n"):(l+="   getLightDirPoint(data, light"+b+"_position);\n",l=d.getFalloffMode()==pc.LIGHTFALLOFF_LINEAR?
l+("   data.atten = getFalloffLinear(data, light"+b+"_radius);\n"):l+("   data.atten = getFalloffInvSquared(data, light"+b+"_radius);\n"),v==pc.LIGHTTYPE_SPOT&&(l+="   data.atten *= getSpotEffect(data, light"+b+"_spotDirection, light"+b+"_innerConeAngle, light"+b+"_outerConeAngle);\n")),l+="   data.atten *= getLightDiffuse(data);\n",d.getCastShadows()&&!a.noShadow&&(g=null,d._shadowType<=pc.SHADOW_DEPTHMASK&&(a.shadowSampleType===pc.SHADOWSAMPLE_HARD?g="Hard":d._shadowType===pc.SHADOW_DEPTH&&a.shadowSampleType===
pc.SHADOWSAMPLE_PCF3X3?g="PCF3x3":d._shadowType===pc.SHADOW_DEPTHMASK&&a.shadowSampleType===pc.SHADOWSAMPLE_PCF3X3?g="PCF3x3_YZW":d._shadowType===pc.SHADOW_DEPTHMASK&&a.shadowSampleType===pc.SHADOWSAMPLE_MASK&&(g="Mask")),null!==g&&(v==pc.LIGHTTYPE_POINT?(n="(data, light"+b+"_shadowMap, light"+b+"_shadowParams);\n",d.getNormalOffsetBias()&&(l+="   normalOffsetPointShadow(data, light"+b+"_shadowParams);\n"),l+="   data.atten *= getShadowPoint"+g+n):(y===b?g+="VS":(n="(data, light"+b+"_shadowMatrix, light"+
...
new pc.TextureHandler(this.graphicsDevice,this.assets,this.loader));this.loader.addHandler("text",new pc.TextHandler);this.loader.addHandler("json",new pc.JsonHandler);this.loader.addHandler("audio",new pc.AudioHandler(this._audioManager));this.loader.addHandler("script",new pc.ScriptHandler(this));this.loader.addHandler("scene",new pc.SceneHandler(this));this.loader.addHandler("cubemap",new pc.CubemapHandler(this.graphicsDevice,this.assets,this.loader));this.loader.addHandler("hierarchy",new pc.HierarchyHandler(this));
this.loader.addHandler("scenesettings",new pc.SceneSettingsHandler(this));new pc.RigidBodyComponentSystem(this);new pc.CollisionComponentSystem(this);new pc.BallSocketJointComponentSystem(this);new pc.AnimationComponentSystem(this);new pc.ModelComponentSystem(this);new pc.CameraComponentSystem(this);new pc.LightComponentSystem(this);new pc.ScriptComponentSystem(this,d.scriptPrefix);new pc.PickComponentSystem(this);new pc.AudioSourceComponentSystem(this,this._audioManager);new pc.AudioListenerComponentSystem(this,
this._audioManager);new pc.ParticleSystemComponentSystem(this);void 0!==document.hidden?(this._hiddenAttr="hidden",document.addEventListener("visibilitychange",this.onVisibilityChange.bind(this),!1)):void 0!==document.mozHidden?(this._hiddenAttr="mozHidden",document.addEventListener("mozvisibilitychange",this.onVisibilityChange.bind(this),!1)):void 0!==document.msHidden?(this._hiddenAttr="msHidden",document.addEventListener("msvisibilitychange",this.onVisibilityChange.bind(this),!1)):void 0!==document.webkitHidden&&
(this._hiddenAttr="webkitHidden",document.addEventListener("webkitvisibilitychange",this.onVisibilityChange.bind(this),!1))};f._currentApplication=null;f._applications={};f.getApplication=function(a){return a?f._applications[a]:f._currentApplication};var a=function(a){this.length=a;this.count=0;this.inc=function(){this.count++};this.done=function(){return this.count===this.length}};f.prototype={configure:function(a,d){var e=this;pc.net.http.get(a,function(a){var b=a.assets;e._parseApplicationProperties(a.application_properties,
function(a){e._parseAssets(b);a?d(a):d(null)})},{error:function(a){d(a)}})},preload:function(b){var d=this;d.fire("preload:start");var e=this.assets.list({preload:!0}),g=new a(e.length),f=!1,k=function(){d.graphicsDevice&&(!f&&g.done())&&(f=!0,d.fire("preload:end"),b())},n=e.length,r;if(g.length)for(r=0;r<g.length;r++)e[r].loaded?(g.inc(),d.fire("preload:progress",g.count/n),g.done()&&k()):(e[r].once("load",function(){g.inc();d.fire("preload:progress",g.count/n);g.done()&&k()}),e[r].once("error",
function(){g.inc();d.fire("preload:progress",g.count/n);g.done()&&k()}),this.assets.load(e[r]));else k()},loadSceneHierarchy:function(a,d){var e=this,g=this.loader.getHandler("hierarchy");g.load(a,function(f,k){this._preloadScripts(k,function(){var n=g.open(a,k);e.loader.clearCache(a,"hierarchy");e.root.addChild(n);pc.ComponentSystem.initialize(n);pc.ComponentSystem.postInitialize(n);d&&d(f,n)})}.bind(this))},loadSceneSettings:function(a,d){this.loader.load(a,"scenesettings",function(a,b){a?d&&d(a):
(this.updateSceneSettings(b),d&&d(null))}.bind(this))},loadScene:function(a,d){var e=this,g=!0;this.scene&&(g=!1,this.scene.root.destroy(),this.scene.destroy(),this.scene=null);var f=this.loader.getHandler("scene");f.load(a,function(k,n){k?d&&d(k):this._preloadScripts(n,function(){var k=f.open(a,n);e.loader.clearCache(a,"scene");e.loader.patch({resource:k,type:"scene"},e.assets);e.root.addChild(k.root);e.systems.rigidbody&&"undefined"!==typeof Ammo&&e.systems.rigidbody.setGravity(k._gravity.x,k._gravity.y,
k._gravity.z);g||(pc.ComponentSystem.initialize(k.root),pc.ComponentSystem.postInitialize(k.root));d&&d(null,k)})}.bind(this))},_preloadScripts:function(b,d){var e=this;e.systems.script.preloading=!0;var g=this._getScriptReferences(b),f=0,k=g.length,n=new a(k),r,l=/^http(s)?:\/\//;if(k)for(f=0;f<k;f++)r=g[f],l.test(r.toLowerCase())||(r=pc.path.join(this._scriptPrefix,g[f])),this.loader.load(r,"script",function(a){a&&console.error(a);n.inc();n.done()&&(e.systems.script.preloading=!1,d())});else e.systems.script.preloading=
!1,d()},_parseApplicationProperties:function(a,d){this._width=a.width;this._height=a.height;a.use_device_pixel_ratio&&(this.graphicsDevice.maxPixelRatio=window.devicePixelRatio);this.setCanvasResolution(a.resolution_mode,this._width,this._height);this.setCanvasFillMode(a.fill_mode,this._width,this._height);this._loadLibraries(a.libraries,d)},_loadLibraries:function(a,d){var e=a.length,g=e;if(e)for(var f=0;f<e;++f)this.loader.load(a[f],"script",function(a){g--;a?d(a):0===g&&(this.onLibrariesLoaded(),
d(null))}.bind(this));else d(null)},_parseAssets:function(a){for(var d in a){var e=a[d],g=new pc.Asset(e.name,e.type,e.file,e.data);g.id=parseInt(d);g.preload=e.preload?e.preload:!1;this.assets.add(g)}},_getScriptReferences:function(a){var d,e,g=[];a.settings.priority_scripts&&(g=a.settings.priority_scripts);var f=[],k={};for(d=0;d<g.length;d++)f.push(g[d]),k[g[d]]=!0;a=a.entities;for(e in a)if(a[e].components.script){g=a[e].components.script.scripts;for(d=0;d<g.length;d++)k[g[d].url]||(f.push(g[d].url),
k[g[d].url]=!0)}return f},start:function(){this.fire("start");this.scene||(this.scene=new pc.Scene,this.scene.root=new pc.Entity,this.root.addChild(this.scene.root));if(!this._librariesLoaded)this.onLibrariesLoaded();pc.ComponentSystem.initialize(this.root);pc.ComponentSystem.postInitialize(this.root);this.tick()},update:function(a){pc.ComponentSystem.fixedUpdate(1/60,this._inTools);pc.ComponentSystem.update(a,this._inTools);pc.ComponentSystem.postUpdate(a,this._inTools);this.fire("update",a);this.controller&&
this.controller.update(a);this.mouse&&this.mouse.update(a);this.keyboard&&this.keyboard.update(a);this.gamepads&&this.gamepads.update(a)},render:function(){if(this.scene){this.fire("preRender",null);var a=this.systems.camera.cameras,d=null,e=this.renderer;this.root.syncHierarchy();for(var g=0,f=a.length;g<f;g++)d=a[g],d.frameBegin(),e.render(this.scene,d.camera),d.frameEnd()}},tick:function(){if(this.graphicsDevice){f._currentApplication=this;window.requestAnimationFrame(this.tick.bind(this));var a=
window.performance&&window.performance.now?performance.now():Date.now(),d=(a-(this._time||a))/1E3;this._time=a;d=pc.math.clamp(d,0,0.1);d*=this.timeScale;this.update(d);this.render()}},setCanvasFillMode:function(a,d,e){this._fillMode=a;this.resizeCanvas(d,e)},setCanvasResolution:function(a,d,e){this._resolutionMode=a;a===pc.RESOLUTION_AUTO&&void 0===d&&(d=this.graphicsDevice.canvas.clientWidth,e=this.graphicsDevice.canvas.clientHeight);this.graphicsDevice.resizeCanvas(d,e)},isFullscreen:function(){return!!document.fullscreenElement},
...
pc.FILLMODE_FILL_WINDOW&&(a=e,d=g);this.graphicsDevice.canvas.style.width=a+"px";this.graphicsDevice.canvas.style.height=d+"px";this._resolutionMode===pc.RESOLUTION_AUTO&&this.setCanvasResolution(pc.RESOLUTION_AUTO)}return{width:a,height:d}},onLibrariesLoaded:function(){this._librariesLoaded=!0;this.systems.rigidbody.onLibraryLoaded();this.systems.collision.onLibraryLoaded()},updateSceneSettings:function(a){var d=this;if(d.systems.rigidbody&&"undefined"!==typeof Ammo){var e=a.physics.gravity;d.systems.rigidbody.setGravity(e[0],
e[1],e[2])}if(d.scene)if(e=a.render.global_ambient,d.scene.ambientLight.set(e[0],e[1],e[2]),d.scene.fog=a.render.fog,d.scene.fogStart=a.render.fog_start,d.scene.fogEnd=a.render.fog_end,e=a.render.fog_color,d.scene.fogColor=new pc.Color(e[0],e[1],e[2]),d.scene.fogDensity=a.render.fog_density,d.scene.gammaCorrection=a.render.gamma_correction,d.scene.toneMapping=a.render.tonemapping,d.scene.exposure=a.render.exposure,d.scene.skyboxIntensity=void 0===a.render.skyboxIntensity?1:a.render.skyboxIntensity,
d.scene.skyboxMip=void 0===a.render.skyboxMip?0:a.render.skyboxMip,a.render.skybox)if(e=d.assets.get(a.render.skybox))e.ready(function(a){d.scene.attachSkyboxAsset(a)}),d.assets.load(e);else d.assets.once("add:"+a.render.skybox,function(a){a.ready(function(a){d.scene.attachSkyboxAsset(a)});d.assets.load(a)});else d.scene.setSkybox(null)},destroy:function(){f._applications[this.graphicsDevice.canvas.id]=null;this.off("librariesloaded");document.removeEventListener("visibilitychange");document.removeEventListener("mozvisibilitychange");
document.removeEventListener("msvisibilitychange");document.removeEventListener("webkitvisibilitychange");this.mouse&&(this.mouse.off("mouseup"),this.mouse.off("mousedown"),this.mouse.off("mousewheel"),this.mouse.off("mousemove"),this.mouse=null);this.keyboard&&(this.keyboard.off("keydown"),this.keyboard.off("keyup"),this.keyboard.off("keypress"),this.keyboard=null);this.touch&&(this.touch.off("touchstart"),this.touch.off("touchend"),this.touch.off("touchmove"),this.touch.off("touchcancel"),this.touch=
null);this.controller&&(this.controller=null);this.root.destroy();pc.ComponentSystem.destroy();this.loader.destroy();this.scene=this.loader=null;this.systems=[];this.renderer=this.graphicsDevice=this.context=null;this._audioManager&&(this._audioManager.destroy(),this._audioManager=null);pc.net.http=new pc.net.Http}};return{FILLMODE_NONE:"NONE",FILLMODE_FILL_WINDOW:"FILL_WINDOW",FILLMODE_KEEP_ASPECT:"KEEP_ASPECT",RESOLUTION_AUTO:"AUTO",RESOLUTION_FIXED:"FIXED",Application:f}}());pc.extend(pc,function(){var f=function(){};f.prototype={add:function(a,b){if(this[a])throw Error(pc.string.format("ComponentSystem name '{0}' already registered or not allowed",a));this[a]=b;b.name=a},remove:function(a){if(!this[a])throw Error(pc.string.format("No ComponentSystem named '{0}' registered",a));delete this[a]},list:function(){var a=Object.keys(this),b={collisionrect:0.5,collisioncircle:0.5};a.sort(function(a,e){var g=b[a]||1,f=b[e]||1;return g<f?-1:g>f?1:0});return a.map(function(a){return this[a]},
...
function(b){b.ready(function(b){f.parameters[s].data=b.resource;k.init(f);b.off("change",a,k);b.on("change",a,k)});h.load(b)});else{if(r)h.once("add:url:"+pc.path.join(n,m.data),function(b){b.ready(function(b){f.parameters[s].data=b.resource;k.init(f);b.off("change",a,k);b.on("change",a,k)});h.load(b)})}else if("cubemap"===m.type&&m.data&&!(m.data instanceof pc.Texture))if(r?d=h.getByUrl(pc.path.join(n,m.data)):(l=m.data,d=h.get(m.data)),d)d.ready(function(a){m.data=a.resource;1<a.resources.length&&
(f.parameters.push({name:"prefilteredCubeMap128",data:a.resources[1]}),f.parameters.push({name:"prefilteredCubeMap64",data:a.resources[2]}),f.parameters.push({name:"prefilteredCubeMap32",data:a.resources[3]}),f.parameters.push({name:"prefilteredCubeMap16",data:a.resources[4]}),f.parameters.push({name:"prefilteredCubeMap8",data:a.resources[5]}),f.parameters.push({name:"prefilteredCubeMap4",data:a.resources[6]}));k.init(f);a.off("change",b,k);a.on("change",b,k)}),h.load(d);else if(l)h.once("add:"+l,
function(a){a.ready(function(a){m.data=a.resource;1<a.resources.length&&(f.parameters.push({name:"prefilteredCubeMap128",data:a.resources[1]}),f.parameters.push({name:"prefilteredCubeMap64",data:a.resources[2]}),f.parameters.push({name:"prefilteredCubeMap32",data:a.resources[3]}),f.parameters.push({name:"prefilteredCubeMap16",data:a.resources[4]}),f.parameters.push({name:"prefilteredCubeMap8",data:a.resources[5]}),f.parameters.push({name:"prefilteredCubeMap4",data:a.resources[6]}));k.init(f);a.off("change",
b,k);a.on("change",b,k)});h.load(a)});else if(r)h.once("add:url:"+pc.path.join(n,m.data),function(a){a.ready(function(a){f.parameters[s].data=a.resource;k.init(f);a.off("change",b,k);a.on("change",b,k)});h.load(a)})});k.init(f)}};return{MaterialHandler:d}}());pc.extend(pc,function(){var f=function(a){this._device=a};f.DEFAULT_MATERIAL=new pc.PhongMaterial;f.prototype={load:function(a,b){pc.net.http.get(a,function(a){b&&b(null,a)},{error:function(d){b&&b(pc.string.format("Error loading model: {0} [{1}]",a,d))}})},open:function(a,b){var d=null;1>=b.model.version?logERROR(pc.string.format("Asset: {0}, is an old model format. Upload source assets to re-import.",a)):2<=b.model.version&&(d=(new pc.JsonModelParser(this._device)).parse(b));return d},patch:function(a,
