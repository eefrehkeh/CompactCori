/*
 PlayCanvas Engine v0.169.15 revision ab11485
 http://playcanvas.com
...
*/
var pc={version:"0.169.15",revision:"ab11485",config:{},common:{},apps:{},data:{},unpack:function(){console.warn("pc.unpack has been deprecated and will be removed shortly. Please update your code.")},makeArray:function(f){var a,b=[],d=f.length;for(a=0;a<d;++a)b.push(f[a]);return b},type:function(f){if(null===f)return"null";var a=typeof f;return"undefined"==a||"number"==a||"string"==a||"boolean"==a?a:_typeLookup[Object.prototype.toString.call(f)]},extend:function(f,a){var b,d;
...
d.scene.skyboxMip=void 0===a.render.skyboxMip?0:a.render.skyboxMip,a.render.skybox)if(e=d.assets.get(a.render.skybox))!1!==e.data.skipFaces&&(e.data.skipFaces=e.file&&0!==d.scene.skyboxMip,!1===e.data.skipFaces&&(e.loaded=!1)),e.ready(function(a){d.scene.attachSkyboxAsset(a)}),d.assets.load(e);else d.assets.once("add:"+a.render.skybox,function(a){a.ready(function(a){d.scene.attachSkyboxAsset(a)});d.assets.load(a)});else d.scene.setSkybox(null)},destroy:function(){f._applications[this.graphicsDevice.canvas.id]=
null;this.off("librariesloaded");document.removeEventListener("visibilitychange");document.removeEventListener("mozvisibilitychange");document.removeEventListener("msvisibilitychange");document.removeEventListener("webkitvisibilitychange");this.mouse&&(this.mouse.off("mouseup"),this.mouse.off("mousedown"),this.mouse.off("mousewheel"),this.mouse.off("mousemove"),this.mouse=null);this.keyboard&&(this.keyboard.off("keydown"),this.keyboard.off("keyup"),this.keyboard.off("keypress"),this.keyboard=null);
this.touch&&(this.touch.off("touchstart"),this.touch.off("touchend"),this.touch.off("touchmove"),this.touch.off("touchcancel"),this.touch=null);this.controller&&(this.controller=null);this.root.destroy();pc.ComponentSystem.destroy();this.loader.destroy();this.scene=this.loader=null;this.systems=[];this.renderer=this.graphicsDevice=this.context=null;this._audioManager&&(this._audioManager.destroy(),this._audioManager=null);pc.net.http=new pc.net.Http}};return{FILLMODE_NONE:"NONE",FILLMODE_FILL_WINDOW:"FILL_WINDOW",
